...
for i in range(0, rowsLen):
    ...
    for j in range(0, 1):
        ...
        eachColumn = columns[0].text #name
        eachColumn2 = columns[1].text #lng
        eachColumn3 = columns[16].text #
        eachColumn4 = columns[4].text
...
# print(df_result[0][19])
#수정본
df_result.to_csv('food2.csv' ,encoding='utf-8-sig')
